...
public class FloatingWindowManager {
    ...
    private JSONArray cachedCruiseLights = null; // [MOD]巡航红绿灯缓存
...
//    }
    ...
    private void ensureClusterMirror() {
        ...
        if (clusterFloatingView == null) {
            ...
            View inflated = new FrameLayout(clusterContext); // [MOD]模块化副屏：空宿主容器
            applyCustomWindowWidth(inflated, layoutRes);
            ...
            clusterActiveWindow = new CustomDisplayWindow(clusterContext, inflated); // [MOD]模块化副屏：唯一窗口
            if (clusterActiveWindow != null) {
